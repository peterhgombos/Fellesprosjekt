...
public class Calendar extends JPanel implements MessageListener {
	...
	private void resize(){
		lastWeek.setBounds(GuiConstants.DISTANCE*30, GuiConstants.DISTANCE, 30, GuiConstants.BUTTON_HEIGTH);
		...
		nextWeek.setBounds(yearField.getX() + yearField.getWidth() + GuiConstants.DISTANCE + weekLabel.getWidth(), yearField.getY(), 30, GuiConstants.BUTTON_HEIGTH);
